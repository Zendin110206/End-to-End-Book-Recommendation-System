...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ...
            clean_data_file_path = os.path.join(self.data_validation_config.clean_data_dir, 'clean_data.csv')
            final_rating.to_csv(clean_data_file_path, index=False)
            logging.info(f"Saved cleaned data to {clean_data_file_path}")
